...
SOURCES = ft_itoa.c ft_itoa_ui.c ft_itoa_x_ul.c ft_itoa_x.c \
			...
			get_hex_upper.c get_int.c get_int_utils.c get_percent.c \
			get_pointer.c get_str.c get_uint.c get_uint_utils.c \
			ft_itoa_x_upper.c parse_flags.c parse_flags_num.c
